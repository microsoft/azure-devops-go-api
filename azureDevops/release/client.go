...
func (client Client) GetApprovals(project *string, assignedToFilter *string, statusFilter *string, releaseIdsFilter *[]int, typeFilter *string, top *int, continuationToken *int, queryOrder *string, includeMyGroupApprovals *bool) (*[]ReleaseApproval, error) {
...
func (client Client) UpdateReleaseApproval(approval *ReleaseApproval, project *string, approvalId *int) (*ReleaseApproval, error) {
    if approval == nil {
        return nil, errors.New("approval is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    ...
    routeValues["project"] = *project
    if approvalId == nil {
        return nil, errors.New("approvalId is a required parameter")
    }
...
func (client Client) GetReleaseTaskAttachmentContent(project *string, releaseId *int, environmentId *int, attemptId *int, planId *uuid.UUID, timelineId *uuid.UUID, recordId *uuid.UUID, type_ *string, name *string) (*interface{}, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    if environmentId == nil {
        return nil, errors.New("environmentId is a required parameter")
    }
    routeValues["environmentId"] = strconv.Itoa(*environmentId)
    if attemptId == nil {
        return nil, errors.New("attemptId is a required parameter")
    }
...
// planId (required): Plan Id of the deploy phase.
// type_ (required): Type of the attachment.
func (client Client) GetReleaseTaskAttachments(project *string, releaseId *int, environmentId *int, attemptId *int, planId *uuid.UUID, type_ *string) (*[]ReleaseTaskAttachment, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
// project (required): Project ID or project name
func (client Client) CreateReleaseDefinition(releaseDefinition *ReleaseDefinition, project *string) (*ReleaseDefinition, error) {
    if releaseDefinition == nil {
        return nil, errors.New("releaseDefinition is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
func (client Client) DeleteReleaseDefinition(project *string, definitionId *int, comment *string, forceDelete *bool) error {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
...
func (client Client) GetReleaseDefinition(project *string, definitionId *int, propertyFilters *[]string) (*ReleaseDefinition, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) GetReleaseDefinitions(project *string, searchText *string, expand *string, artifactType *string, artifactSourceId *string, top *int, continuationToken *string, queryOrder *string, path *string, isExactNameMatch *bool, tagFilter *[]string, propertyFilters *[]string, definitionIdFilter *[]string, isDeleted *bool, searchTextContainsFolderName *bool) (*[]ReleaseDefinition, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
// project (required): Project ID or project name
func (client Client) UpdateReleaseDefinition(releaseDefinition *ReleaseDefinition, project *string) (*ReleaseDefinition, error) {
    if releaseDefinition == nil {
        return nil, errors.New("releaseDefinition is a required parameter")
    }
    routeValues := make(map[string]string)
...
func (client Client) GetDeployments(project *string, definitionId *int, definitionEnvironmentId *int, createdBy *string, minModifiedTime *time.Time, maxModifiedTime *time.Time, deploymentStatus *string, operationStatus *string, latestAttemptsOnly *bool, queryOrder *string, top *int, continuationToken *int, createdFor *string, minStartedTime *time.Time, maxStartedTime *time.Time, sourceBranch *string) (*[]Deployment, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
// releaseId (required): Id of the release.
// environmentId (required): Id of the release environment.
func (client Client) GetReleaseEnvironment(project *string, releaseId *int, environmentId *int) (*ReleaseEnvironment, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    resp, err := client.Client.Send(http.MethodGet, locationId, "5.1-preview.6", routeValues, nil, nil, "", "application/json", nil)
    if err != nil {
        return nil, err
    }
...
func (client Client) UpdateReleaseEnvironment(environmentUpdateData *ReleaseEnvironmentUpdateMetadata, project *string, releaseId *int, environmentId *int) (*ReleaseEnvironment, error) {
    if environmentUpdateData == nil {
        return nil, errors.New("environmentUpdateData is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    ...
    locationId, _ := uuid.Parse("a7e426b1-03dc-48af-9dfe-c98bac612dcb")
    resp, err := client.Client.Send(http.MethodPatch, locationId, "5.1-preview.6", routeValues, nil, bytes.NewReader(body), "application/json", "application/json", nil)
    if err != nil {
        return nil, err
    }
...
func (client Client) UpdateGates(gateUpdateMetadata *GateUpdateMetadata, project *string, gateStepId *int) (*ReleaseGates, error) {
    if gateUpdateMetadata == nil {
        return nil, errors.New("gateUpdateMetadata is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    ...
    routeValues["project"] = *project
    if gateStepId == nil {
        return nil, errors.New("gateStepId is a required parameter")
    }
...
// project (required): Project ID or project name
// releaseId (required): Id of the release.
func (client Client) GetLogs(project *string, releaseId *int) (*interface{}, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    resp, err := client.Client.Send(http.MethodGet, locationId, "5.1-preview.2", routeValues, nil, nil, "", "application/zip", nil)
    if err != nil {
        return nil, err
    }
...
func (client Client) GetTaskLog(project *string, releaseId *int, environmentId *int, releaseDeployPhaseId *int, taskId *int, startLine *uint64, endLine *uint64) (*interface{}, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    if releaseDeployPhaseId == nil {
        return nil, errors.New("releaseDeployPhaseId is a required parameter")
    }
    routeValues["releaseDeployPhaseId"] = strconv.Itoa(*releaseDeployPhaseId)
    if taskId == nil {
        return nil, errors.New("taskId is a required parameter")
    }
    ...
    resp, err := client.Client.Send(http.MethodGet, locationId, "5.1-preview.2", routeValues, queryParams, nil, "", "text/plain", nil)
    if err != nil {
        return nil, err
    }
...
func (client Client) GetManualIntervention(project *string, releaseId *int, manualInterventionId *int) (*ManualIntervention, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    if manualInterventionId == nil {
        return nil, errors.New("manualInterventionId is a required parameter")
    }
...
// project (required): Project ID or project name
// releaseId (required): Id of the release.
func (client Client) GetManualInterventions(project *string, releaseId *int) (*[]ManualIntervention, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
// releaseId (required): Id of the release.
// manualInterventionId (required): Id of the manual intervention.
func (client Client) UpdateManualIntervention(manualInterventionUpdateMetadata *ManualInterventionUpdateMetadata, project *string, releaseId *int, manualInterventionId *int) (*ManualIntervention, error) {
    if manualInterventionUpdateMetadata == nil {
        return nil, errors.New("manualInterventionUpdateMetadata is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
// project (required): Project ID or project name
func (client Client) CreateRelease(releaseStartMetadata *ReleaseStartMetadata, project *string) (*Release, error) {
    if releaseStartMetadata == nil {
        return nil, errors.New("releaseStartMetadata is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
func (client Client) GetRelease(project *string, releaseId *int, approvalFilters *string, propertyFilters *[]string, expand *string, topGateRecords *int) (*Release, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) GetReleaseRevision(project *string, releaseId *int, definitionSnapshotRevision *int) (*interface{}, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    if definitionSnapshotRevision == nil {
        return nil, errors.New("definitionSnapshotRevision is a required parameter")
    }
...
func (client Client) UpdateRelease(release *Release, project *string, releaseId *int) (*Release, error) {
    if release == nil {
        return nil, errors.New("release is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
// project (required): Project ID or project name
// releaseId (required): Id of the release to update.
func (client Client) UpdateReleaseResource(releaseUpdateMetadata *ReleaseUpdateMetadata, project *string, releaseId *int) (*Release, error) {
    if releaseUpdateMetadata == nil {
        return nil, errors.New("releaseUpdateMetadata is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
func (client Client) GetDefinitionRevision(project *string, definitionId *int, revision *int) (*interface{}, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    routeValues["definitionId"] = strconv.Itoa(*definitionId)
    if revision == nil {
        return nil, errors.New("revision is a required parameter")
    }
...
// project (required): Project ID or project name
// definitionId (required): Id of the definition.
func (client Client) GetReleaseDefinitionHistory(project *string, definitionId *int) (*[]ReleaseDefinitionRevision, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
