...
func (client Client) RemoveAccessControlEntries(securityNamespaceId *uuid.UUID, token *string, descriptors *string) (*bool, error) {
    routeValues := make(map[string]string)
    if securityNamespaceId == nil {
        return nil, errors.New("securityNamespaceId is a required parameter")
    }
...
// container (required)
// securityNamespaceId (required): Security namespace identifier.
func (client Client) SetAccessControlEntries(container *interface{}, securityNamespaceId *uuid.UUID) (*[]AccessControlEntry, error) {
    if container == nil {
...
func (client Client) QueryAccessControlLists(securityNamespaceId *uuid.UUID, token *string, descriptors *string, includeExtendedInfo *bool, recurse *bool) (*[]AccessControlList, error) {
    routeValues := make(map[string]string)
    if securityNamespaceId == nil {
        return nil, errors.New("securityNamespaceId is a required parameter")
    }
...
func (client Client) RemoveAccessControlLists(securityNamespaceId *uuid.UUID, tokens *string, recurse *bool) (*bool, error) {
    routeValues := make(map[string]string)
    if securityNamespaceId == nil {
        return nil, errors.New("securityNamespaceId is a required parameter")
    }
...
// securityNamespaceId (required): Security namespace identifier.
func (client Client) SetAccessControlLists(accessControlLists *azureDevops.VssJsonCollectionWrapper, securityNamespaceId *uuid.UUID) error {
    if accessControlLists == nil {
        return errors.New("accessControlLists is a required parameter")
    }
    routeValues := make(map[string]string)
    if securityNamespaceId == nil {
        return errors.New("securityNamespaceId is a required parameter")
    }
    routeValues["securityNamespaceId"] = (*securityNamespaceId).String()
    ...
    locationId, _ := uuid.Parse("18a2ad18-7571-46ae-bec7-0c7da1495885")
    _, err := client.Client.Send(http.MethodPost, locationId, "5.1", routeValues, nil, bytes.NewReader(body), "application/json", "application/json", nil)
    if err != nil {
        return err
    }
...
func (client Client) HasPermissionsBatch(evalBatch *PermissionEvaluationBatch) (*PermissionEvaluationBatch, error) {
    if evalBatch == nil {
        return nil, errors.New("evalBatch is a required parameter")
    }
...
func (client Client) HasPermissions(securityNamespaceId *uuid.UUID, permissions *int, tokens *string, alwaysAllowAdministrators *bool, delimiter *string) (*[]bool, error) {
    routeValues := make(map[string]string)
    if securityNamespaceId == nil {
        return nil, errors.New("securityNamespaceId is a required parameter")
    }
...
func (client Client) RemovePermission(securityNamespaceId *uuid.UUID, descriptor *string, permissions *int, token *string) (*AccessControlEntry, error) {
    routeValues := make(map[string]string)
    if securityNamespaceId == nil {
        return nil, errors.New("securityNamespaceId is a required parameter")
    }
    ...
    queryParams := url.Values{}
    if descriptor == nil {
        return nil, errors.New("descriptor is a required parameter")
    }
...
func (client Client) QuerySecurityNamespaces(securityNamespaceId *uuid.UUID, localOnly *bool) (*[]SecurityNamespaceDescription, error) {
    routeValues := make(map[string]string)
    if securityNamespaceId != nil {
        routeValues["securityNamespaceId"] = (*securityNamespaceId).String()
    }
