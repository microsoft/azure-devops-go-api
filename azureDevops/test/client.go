...
func (client Client) GetActionResults(project *string, runId *int, testCaseResultId *int, iterationId *int, actionPath *string) (*[]TestActionResultModel, error) {
...
func (client Client) GetTestIteration(project *string, runId *int, testCaseResultId *int, iterationId *int, includeActionResults *bool) (*TestIterationDetailsModel, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
// testCaseResultId (required): ID of the test result that contains the iterations.
// includeActionResults (optional): Include result details for each action performed in the test iteration. ActionResults refer to outcome (pass/fail) of test steps that are executed as part of a running a manual test. Including the ActionResults flag gets the outcome of test steps in the actionResults section and test parameters in the parameters section for each test iteration.
func (client Client) GetTestIterations(project *string, runId *int, testCaseResultId *int, includeActionResults *bool) (*[]TestIterationDetailsModel, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) GetResultParameters(project *string, runId *int, testCaseResultId *int, iterationId *int, paramName *string) (*[]TestResultParameterModel, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) GetPoint(project *string, planId *int, suiteId *int, pointIds *int, witFields *string) (*TestPoint, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) GetPoints(project *string, planId *int, suiteId *int, witFields *string, configurationId *string, testCaseId *string, testPointIds *string, includePointDetails *bool, skip *int, top *int) (*[]TestPoint, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) UpdateTestPoints(pointUpdateModel *PointUpdateModel, project *string, planId *int, suiteId *int, pointIds *string) (*[]TestPoint, error) {
    if pointUpdateModel == nil {
        return nil, errors.New("pointUpdateModel is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
// skip (optional): Number of test points to skip..
// top (optional): Number of test points to return.
func (client Client) GetPointsByQuery(query *TestPointsQuery, project *string, skip *int, top *int) (*TestPointsQuery, error) {
    if query == nil {
...
// project (required): Project ID or project name
func (client Client) GetResultRetentionSettings(project *string) (*ResultRetentionSettings, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
// project (required): Project ID or project name
func (client Client) UpdateResultRetentionSettings(retentionSettings *ResultRetentionSettings, project *string) (*ResultRetentionSettings, error) {
    if retentionSettings == nil {
        return nil, errors.New("retentionSettings is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
func (client Client) GetTestResultById(project *string, runId *int, testCaseResultId *int, detailsToInclude *string) (*TestCaseResult, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) GetTestRunById(project *string, runId *int, includeDetails *bool) (*TestRun, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) CreateTestSession(testSession *TestSession, project *string, team *string) (*TestSession, error) {
    if testSession == nil {
        return nil, errors.New("testSession is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
...
func (client Client) GetTestSessions(project *string, team *string, period *int, allSessions *bool, includeAllProperties *bool, source *string, includeOnlyCompletedSessions *bool) (*[]TestSession, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
// project (required): Project ID or project name
// team (optional): Team ID or team name
func (client Client) UpdateTestSession(testSession *TestSession, project *string, team *string) (*TestSession, error) {
    if testSession == nil {
        return nil, errors.New("testSession is a required parameter")
    }
    routeValues := make(map[string]string)
...
func (client Client) AddTestCasesToSuite(project *string, planId *int, suiteId *int, testCaseIds *string) (*[]SuiteTestCase, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
    ...
    resp, err := client.Client.Send(http.MethodPost, locationId, "5.1", routeValues, nil, nil, "", "application/json", nil)
    if err != nil {
        return nil, err
    }
...
func (client Client) GetTestCaseById(project *string, planId *int, suiteId *int, testCaseIds *int) (*SuiteTestCase, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) GetTestCases(project *string, planId *int, suiteId *int) (*[]SuiteTestCase, error) {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
    }
...
func (client Client) RemoveTestCasesFromSuiteUrl(project *string, planId *int, suiteId *int, testCaseIds *string) error {
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return errors.New("project is a required parameter")
    }
...
// suiteId (required): ID of the test suite to which the test cases must be added.
// testCaseIds (required): IDs of the test cases to add to the suite. Ids are specified in comma separated format.
func (client Client) UpdateSuiteTestCases(suiteTestCaseUpdateModel *SuiteTestCaseUpdateModel, project *string, planId *int, suiteId *int, testCaseIds *string) (*[]SuiteTestCase, error) {
    if suiteTestCaseUpdateModel == nil {
        return nil, errors.New("suiteTestCaseUpdateModel is a required parameter")
    }
    routeValues := make(map[string]string)
    if project == nil || *project == "" {
        return nil, errors.New("project is a required parameter")
